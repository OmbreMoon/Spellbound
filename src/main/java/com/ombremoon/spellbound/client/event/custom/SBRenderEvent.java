...
public abstract class SBRenderEvent {
    ...
    public abstract static class SpellCast extends Event implements GeoRenderEvent {
        private final SpellCastRenderer<?> renderer;

        public SpellCast(SpellCastRenderer<?> renderer) {
            this.renderer = renderer;
        }

        @Override
        public SpellCastRenderer<?> getRenderer() {
            return this.renderer;
        }
        ...
        public static class Pre extends SpellCast implements ICancellableEvent {
            private final PoseStack poseStack;
            private final BakedGeoModel model;
            private final MultiBufferSource bufferSource;
            private final float partialTick;
            ...
            public Pre(SpellCastRenderer<?> renderer, PoseStack poseStack, BakedGeoModel model, MultiBufferSource bufferSource, float partialTick, int packedLight) {
                super(renderer);
                this.poseStack = poseStack;
                this.model = model;
                this.bufferSource = bufferSource;
        ...
        public static class Post extends SpellCast {
            private final PoseStack poseStack;
            private final BakedGeoModel model;
            private final MultiBufferSource bufferSource;
            private final float partialTick;
            ...
            public Post(SpellCastRenderer<?> renderer, PoseStack poseStack, BakedGeoModel model, MultiBufferSource bufferSource, float partialTick, int packedLight) {
                super(renderer);
                this.poseStack = poseStack;
                this.model = model;
                this.bufferSource = bufferSource;
        ...
        public static class CompileRenderLayers extends SpellCast {
            public CompileRenderLayers(SpellCastRenderer<?> renderer) {
                super(renderer);
            }
