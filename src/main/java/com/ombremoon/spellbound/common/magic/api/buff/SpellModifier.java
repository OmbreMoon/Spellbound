...
public record SpellModifier(ResourceLocation id, ModifierType modifierType, Predicate<SpellType<?>> spellPredicate, float modifier, Operation operation) {
    ...
    public static final SpellModifier ETERNAL_SPRING = registerModifier("eternal_spring", ModifierType.DURATION, spell -> spell == SBSpells.HEALING_BLOSSOM.get(), 100, Operation.ADD);
