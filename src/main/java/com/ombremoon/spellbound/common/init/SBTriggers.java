...
import com.ombremoon.spellbound.common.magic.acquisition.divine.triggers.PlayerActionTrigger;
...
public class SBTriggers {
    ...
    public static final Supplier<PlayerActionTrigger> TEST_TRIGGER = register("test", new PlayerActionTrigger());
